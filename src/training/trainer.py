...
class Trainer:
    ...
    def train_epoch(self, epoch: int) -> Dict[str, float]:
        ...
        for batch_idx, (images, targets) in enumerate(self.train_loader):
            ...
            if self.use_mixup:
                images, targets_a, targets_b, lam = mixup_batch(images, targets_device, alpha=self.mixup_alpha)
            ...
            if self.use_amp:
                ...
                with torch.amp.autocast("cuda"):
                    ...
                    if lam is not None and targets_b is not None:
                        ...
                        losses = {k: lam * losses_a[k] + (1 - lam) * losses_b[k] for k in losses_a}
                    else:
    ...
    def resume(self, checkpoint_path: str) -> int:
        ...
        logger.info(f"Resumed from checkpoint: epoch={start_epoch}, " f"best_val_loss={self.best_val_loss:.4f}")
